...
class BiddingLoading extends StatefulWidget {
  ...
  @override
  _BiddingLoadingState createState() =>
      _BiddingLoadingState(service_data, createdTime, serviceId, id_, screen);
}
...
class _BiddingLoadingState extends State<BiddingLoading> {
  ...
  _BiddingLoadingState(this.service_data, this.createdTime, this.serviceId,
      this.id_, this.screen);
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => BiddingActivity(
                      screen: 1, solutionType: widget.solutionType),
                ));
          }
        } else {
                        ...
                        children: <Widget>[
                          ...
                          Align(
                            child: AnimatedContainer(
                              ...
                              child: Center(
                                child: Image.asset(
                                  'assets/images/bid/bid_active.png',
                                  height: 70,
                                  width: 70,
                                ),
                              ),
