...
class _BiddingActivityState extends State<BiddingActivity> {
  ...
  Widget build(BuildContext context) {
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Expanded(child: Container(
              ...
              child: Text("Solutions", style: TextStyle(color:
    ...
    final loading = Expanded(child:  ListView.builder(itemBuilder: (context, index) {
    ...
    final form = Container(
      ...
      child: Column(
        children: <Widget>[
          top,
          progress? loading:  list_solutions
      ...
      return ListView.builder(
          itemBuilder: (context, index) {
            ...
            for(int i =0; i< business.length; i++){
              pos = config.Config.procedure_id.indexOf(business[index].serviceId);
            }
            ...
            return price.length == 0? Container(
              child: Center(
                child: Text(""),
              ),
            ): InkWell(
              ...
              child: Container(
                child: Padding(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                           business[index].imageUrl != '' ? CircleAvatar(
                                  radius: 20,
                                  backgroundImage: NetworkImage(
                                    ...
                                    alignment: Alignment.center,
                                    child:
                                    Text(config.Config.get_initial_name(business[index].name).toUpperCase(),
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(child: Text(business[index].name, style: TextStyle(fontWeight: FontWeight.w600),)),
                                  Text(config.Config.get_duration(business[index].createdTime), style: TextStyle(
                                      color: Colors.grey),)
                          ...
                          Container(
                            child: Row(
                              children: <Widget>[
                                ...
                                Expanded(child: Text(config.Config.procedure_name[pos], style: TextStyle(color: Colors.grey),)),
                                SizedBox(width: 10,),
                                price.length != 0?   Text("₹"+price[0].toString()): Text("")
      ...
      return Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 20,),
            Text("Please make sure you book\n"
            ...
            child: ListView.builder(
              itemBuilder: (context, index) {
                ...
                for(int i =0; i< personal.length; i++){
                   pos = config.Config.procedure_id.indexOf(personal[index].serviceId);
                }

                return Container(
                  child: InkWell(
                    onTap: () {
                     int mins =  config.Config.get_minutes_diff(personal[index].createdTime);
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Expanded(
                                    flex: 2,
                                    child: Container(
                                      child: Text(config.Config.procedure_name[pos]),
                                    ),
                                  ),
                                  Expanded(
                                    flex: 1,
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          //  snapshot.toString() == '0' ?
                                          Text(
                                            personal[index].services.length.toString() +
                                                " received",
                                            style: TextStyle(
                                              color: Color(
                                                  0xff01d35a),
                                          ...
                                          Text(
                                            config.Config.get_duration(personal[index].createdTime),
                                            style: TextStyle(
                                              color: Colors.grey,
                                              fontSize: 12,
                                            ),
