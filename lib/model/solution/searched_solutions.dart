...
//    print("SearchedSolutions=>"+response.statusCode.toString());
    ...
    var error_body = {"success": false, "message": "Something went wrong!"};
...
class SearchedSolutions {
  ...
  factory SearchedSolutions.fromJson(Map<String, dynamic> json) {
    return SearchedSolutions(
      ...
      personal: List<PersonelData>.from(
          json['personal'].map((i) => PersonelData.fromJson(i))),
      business: List<BusinessData>.from(
          json['business'].map((i) => BusinessData.fromJson(i))),
    );
  }
}
...
class PersonelData {
  ...
  factory PersonelData.fromJson(Map<String, dynamic> parsedJson) {
    return new PersonelData(
      createdTime:
          parsedJson['createdTime'] != null ? parsedJson['createdTime'] : '',
      serviceId: parsedJson['serviceId'] != null ? parsedJson['serviceId'] : '',
      id: parsedJson['_id'] != null ? parsedJson['_id'] : '',
      services: List<ServicesData>.from(
          parsedJson['services'].map((i) => ServicesData.fromJson(i))),
    );
  }
}
