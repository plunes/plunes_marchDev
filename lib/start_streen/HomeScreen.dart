  ...
  Widget build(BuildContext context) {
                ...
                children: <Widget>[
                  ...
                  user_type == 'User'
                      ...
                      : ListTile(
                          ...
                          trailing: Text(""),
                          leading: Image.asset(
                            'assets/images/nav/availability.png',
                            height: 25,
                            width: 25,
                          ),
                          title: Text(
                  ...
                  ListTile(
                    ...
                    leading: Image.asset(
                      'assets/images/nav/appintment.png',
                      height: 25,
                      width: 25,
                    ),
                      ...
                      : ListTile(
                          onTap: () {
                            Navigator.popAndPushNamed(
                                context, ManagePayments.tag);
                          },
                          leading: Image.asset(
                            'assets/images/nav/payments.png',
                            height: 25,
                            width: 25,
                          ),
                  ...
                  InkWell(
                    ...
                    child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            "People availing offers near you",
                            style: TextStyle(
                                color: Colors.black,
                                fontSize: 16,
                                fontWeight: FontWeight.w500),
    ...
    return WillPopScope(
        ...
        child: Scaffold(
            ...
            bottomNavigationBar: user_type != 'Hospital'
